...
const Navbar = () => {
    ...
    const SearchBar = () => (
        <div className={`relative ${isSearchExpanded ? 'block' : 'hidden'} md:block`}>
            ...
            />
            <button
                className="absolute inset-y-0 right-0 flex items-center justify-center w-12 h-12 text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="hidden w-full md:flex md:flex-end md:w-auto" id="navbar-default">
                    <ul className="font-medium flex flex-col p-4 md:p-2 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white ">
                        <NavItem href="#" text="Courses"
                                 extraClasses="bg-blue-700 text-white md:bg-transparent md:text-blue-700 md:hover:text-blue-700"/>
                        <NavItem href="#" text="Donate"
                                 extraClasses="text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700"/>
                        <NavItem href="#" text="Log in"
                                 extraClasses="text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700"/>
                        <NavItem href="#" text="Sign up"
                                 extraClasses="text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700"/>
                    </ul>
                </div>
            </div>
